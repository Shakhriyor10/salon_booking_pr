# Generated by Django 3.1 on 2025-12-25 11:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('salon_type', models.CharField(choices=[('male', 'Мужской'), ('female', 'Женский'), ('both', 'Универсальный')], max_length=10)),
                ('photo', models.ImageField(upload_to='salon_applications/')),
                ('photo_2', models.ImageField(blank=True, null=True, upload_to='salon_applications/')),
                ('photo_3', models.ImageField(blank=True, null=True, upload_to='salon_applications/')),
                ('photo_4', models.ImageField(blank=True, null=True, upload_to='salon_applications/')),
                ('photo_5', models.ImageField(blank=True, null=True, upload_to='salon_applications/')),
                ('is_processed', models.BooleanField(default=False)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='applications', to='booking.city')),
            ],
            options={
                'ordering': ['-created_at'],
            },
