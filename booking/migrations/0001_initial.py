# Generated by Django 3.1 on 2025-12-24 20:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appointment_view_style', models.PositiveSmallIntegerField(choices=[(1, 'Дизайн записей — 1'), (2, 'Дизайн записей — 2')], default=1, help_text='По умолчанию используется первый дизайн с календарём и списком. Второй дизайн — шахматное расписание.', verbose_name='Дизайн отображения записей в дашборде')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('salon_name', models.CharField(max_length=150, verbose_name='Название салона')),
                ('city', models.CharField(max_length=150, verbose_name='Город/местоположение')),
                ('address', models.CharField(blank=True, max_length=255, verbose_name='Адрес')),
                ('phone', models.CharField(max_length=32, verbose_name='Номер телефона')),
                ('stylist_count', models.PositiveIntegerField(default=0, verbose_name='Количество мастеров')),
                ('description', models.TextField(blank=True, verbose_name='Комментарий')),
                ('master_photo_1', models.ImageField(blank=True, null=True, upload_to='salon_applications/masters/', verbose_name='Фото мастера 1')),
                ('master_photo_2', models.ImageField(blank=True, null=True, upload_to='salon_applications/masters/', verbose_name='Фото мастера 2')),
                ('master_photo_3', models.ImageField(blank=True, null=True, upload_to='salon_applications/masters/', verbose_name='Фото мастера 3')),
                ('salon_photo_1', models.ImageField(blank=True, null=True, upload_to='salon_applications/salons/', verbose_name='Фото салона 1')),
                ('salon_photo_2', models.ImageField(blank=True, null=True, upload_to='salon_applications/salons/', verbose_name='Фото салона 2')),
                ('salon_photo_3', models.ImageField(blank=True, null=True, upload_to='salon_applications/salons/', verbose_name='Фото салона 3')),
                ('salon_photo_4', models.ImageField(blank=True, null=True, upload_to='salon_applications/salons/', verbose_name='Фото салона 4')),
                ('salon_photo_5', models.ImageField(blank=True, null=True, upload_to='salon_applications/salons/', verbose_name='Фото салона 5')),
                ('status', models.CharField(choices=[('pending', 'На рассмотрении'), ('approved', 'Одобрено'), ('rejected', 'Отклонено')], default='pending', max_length=20, verbose_name='Статус заявки')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Создано')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='salon_applications', to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
            ],
            options={
